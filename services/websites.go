...
import "beautybargains/models"

// Create a new website and insert it into the Websites table
func (s *Service) CreateWebsite(website models.Website) error {
...
func (s *Service) CountWebsites() (int, error) {
...
func (s *Service) GetAllWebsites(limit, offset int) ([]models.Website, error) {
